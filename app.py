...
app.layout = html.Div([
    ...
    html.Label("k × α"),
    dcc.Slider(id='alpha-slider', min=0.8, max=1.2, step=0.005, value=1.0, marks={i: str(i) for i in range(0.8, 1.2, 0.05)}),
    html.Label("k × χ"),
    dcc.Slider(id='chi-slider', min=0.8, max=1.2, step=0.005, value=1.0, marks={i: str(i) for i in range(0.8, 1.2, 0.05)}),
    html.Label("k × K(T)"),
    dcc.Slider(id='k-scale-slider', min=0.8, max=1.2, step=0.005, value=1.0, marks={i: str(i) for i in range(0.8, 1.2, 0.05)}),
    html.Label("k × m"),
    dcc.Slider(id='m-scale-slider', min=0.8, max=1.2, step=0.005, value=1.0, marks={i: str(i) for i in range(0.8, 1.2, 0.05)}),
    html.Label("k × M"),
    dcc.Slider(id='M-scale-slider', min=0.8, max=1.2, step=0.005, value=1.0, marks={i: str(i) for i in range(0.8, 1.2, 0.05)}),
